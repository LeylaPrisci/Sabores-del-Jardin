...
const Footer: React.FC = () => (
    ...
    <div className="w-full min-h-full">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 pb-8 w-full">
        <div className="md:col-span-2 flex flex-col items-center">
          <Image src="/logo/logoSinFondo.png" alt="Logo Sabores del Jardín" className="w-40 h-auto mb-4" width={160} height={64} />
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><Link href="/productos" className="hover:underline text-white">Productos</Link></li>
  ...
  <div className="flex gap-4 justify-center md:justify-end pr-6">
          <a href="https://www.facebook.com" target="_blank" rel="noopener" aria-label="Facebook" className="hover:text-[#E8C39E]">
            <Image src="/logo/brand-facebook.svg" alt="Facebook" className="w-7 h-7 inline" width={28} height={28} />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener" aria-label="Twitter" className="hover:text-[#E8C39E]">
            <Image src="/logo/brand-twitter.svg" alt="Twitter" className="w-7 h-7 inline" width={28} height={28} />
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener" aria-label="Instagram" className="hover:text-[#E8C39E]">
            <Image src="/logo/brand-instagram.svg" alt="Instagram" className="w-7 h-7 inline" width={28} height={28} />
          </a>
          <a href="https://wa.me/" target="_blank" rel="noopener" aria-label="WhatsApp" className="hover:text-[#E8C39E]">
            <Image src="/logo/brand-whatsapp.svg" alt="WhatsApp" className="w-7 h-7 inline" width={28} height={28} />
          </a>
        </div>
      </div>
