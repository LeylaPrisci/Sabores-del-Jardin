...
const NosotrosPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E8C39E]/20 to-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-8">Nuestro Compromiso</h2>
